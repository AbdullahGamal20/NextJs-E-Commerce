            ...
            <div className="flex items-center gap-4">
              {!user ? (
                <div className="sm:flex sm:gap-4">
                  ...
                  <a
                    className="hidden rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium transition hover:text-teal-500/75 dark:bg-gray-800 dark:text-white dark:hover:text-white/75 sm:block"
                    href="/sign-up"
                  >
                    Register
                  </a>
                ...
                <div className="flex items-center gap-5">
                  <h2 className="flex gap-1 text-white cursor-pointer">
