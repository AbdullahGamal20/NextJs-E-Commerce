...
const page = () => {
  ...
  const getTotalAmount = () => {
    let total = 0;
    cart.forEach((i) => {
      total = total + Number(i?.product?.attributes?.price);
    });
    return total;
  };
          ...
          <div className="mt-8">
            ...
            <div className="mt-8 flex justify-end border-t border-gray-100 pt-8">
              <div className="w-screen max-w-lg space-y-4">
                <dl className="space-y-0.5 text-sm text-primary ">
                ...
                <div className="flex justify-end">
                  <button
                    onClick={() =>
                      router.push(
                        `/checkout?amount=${Math.round(getTotalAmount())}`
                      )
                    }
                    className="block rounded bg-primary px-5 py-3 text-sm text-gray-100 transition hover:bg-primary/80"
                  >
                    Checkout
                  </button>
                </div>
            ...
            <h2 className="bg-gray-100 text-[14px] text-gray-500 rounded-md p-2 w-72 text-center">
