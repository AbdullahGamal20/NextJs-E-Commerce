    ...
    <section className="bg-white">
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          ...
          <div className="hidden lg:relative lg:block lg:p-12 mb-60 text-center">
            <h2 className="mt-6 text-2xl font-bold text-primary sm:text-3xl md:text-4xl">
              Welcome to Furniture Home
            </h2>

            <p className="mt-4 leading-relaxed text-white/90 capitalize text-md">
              Log in to access our exclusive collection of stylish and
              comfortable furniture. Discover new arrivals and special deals
